        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoursLeft = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModuleId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleStudyRecords", x => x.RecordId);
                    table.ForeignKey(
                        name: "FK_ModuleStudyRecords_Modules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModuleStudyRecords_ModuleId",
                table: "ModuleStudyRecords",
                column: "ModuleId");
        }
